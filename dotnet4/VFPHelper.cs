...
namespace jxshell.dotnet4
{
    ...
    public class VFPHelper
    {
        ...
        public Ast Compile()
        {
            ...
            foreach (KeyValuePair<string, jxshell.dotnet4.methodDescriptor> staticMethod in typeD.staticMethods)
            {
            ...
            foreach (KeyValuePair<string, jxshell.dotnet4.methodDescriptor> staticMethod in typeD.instanceMethods)
            {
