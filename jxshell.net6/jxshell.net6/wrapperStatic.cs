...
namespace jxshell.net6
{
	...
	public class wrapperStatic : wrapperBase
	{
        ...
        public static metaObject loadMetavalueFromType(Type t)
        {
            ...
            string name = jxshell.net6.typeDescriptor.getNameForType(t);
            m.value = t;
            m.isstatic = true; 
            m.typeDescriptor= jxshell.net6.typeDescriptor.loadFromType(t, name, false);
            m.name = name;
            return m; 
        }
		...
		public static wrapperStatic loadFromType(Type t)
		{
			...
			{
                var typed = jxshell.net6.typeDescriptor.loadFromType(t);
